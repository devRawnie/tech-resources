...
2. [Git from the bottom up - jwiegley](https://jwiegley.github.io/git-from-the-bottom-up/)
3. [Hashicorp Vault, Series by Yiğit İrez](https://irezyigit.medium.com/vault-from-ground-up-4ee68a4db3ca)
4. [Regex in JS - freeCodeCamp](https://www.freecodecamp.org/news/regex-in-javascript/?ref=dailydev)
5. [Install MS Office using Deployment Tool](https://www.youtube.com/watch?v=Tq03Q-O7py4)

### Non-tech resources
1. [Live Radio](https://www.nts.live/)
